    ...
    <div className={`component ${props.params.styles}`} id={id ? id : undefined}>
      <div className="component-content container py-4">
        <div className="row mb-4">
          <div className="col">
            <Text tag="h2" field={props.rendering?.fields.Title} className="h4 fw-bold" />
          </div>
        </div>
              ...
              <div className="col-lg-4 col-md-6" key={`related-blog-${i}`}>
                <div className="card h-100 shadow-sm">
                  ...
                  <div className="card-body">
                    <a href={rb.urlWrapper.url} className="stretched-link text-decoration-none">
                      <Text field={rb.title} tag="h5" className="card-title mb-0" />
                    </a>
                  </div>
                </div>
              </div>
